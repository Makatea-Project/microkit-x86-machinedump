...
/**
 * Splits a string into space-separated tokens and return the first token. The
...
/**
 * Splits a string formatted as "key=value" into the key and value components.
